...
type TermDefinition = {
  ...
  semantic_domain: "SOCIAL" | "COGNITIVE";
...
const termGroups: Record<QueryGroup, TermDefinition[]> = {
  chart06_social_supplement: [
    ...
    term,
    narrative_role,
    query_group: "chart06_social_supplement",
  ...
  chart06_cognitive_artificial: [
    ...
    term,
    narrative_role,
    query_group: "chart06_cognitive_artificial",
  ...
  chart06_cognitive_infrastructure: [
    ...
    term,
    narrative_role,
    query_group: "chart06_cognitive_infrastructure",
    semantic_domain: "COGNITIVE",
  })),
};

const rawFiles: Record<QueryGroup, string> = {
  chart06_social_supplement: "chart_06_ngram_raw_social_supplement.csv",
  chart06_cognitive_artificial: "chart_06_ngram_raw_cognitive_artificial_supplement.csv",
  chart06_cognitive_infrastructure: "chart_06_ngram_raw_cognitive_infrastructure.csv",
};
...
async function main() {
  ...
  await writeFile(
    path.join(PROCESSED_DIR, "chart_06_supplement_ngram_long.csv"),
    `${csvRows(
      [
        "year",
        "term",
  ...
  await writeFile(
    path.join(PROCESSED_DIR, "chart_06_supplement_term_metadata.csv"),
    `${csvRows(
      [
        "term",
        "term_slug",
  ...
  await writeFile(
    path.join(PROCESSED_DIR, "chart_06_supplement_term_inventory.csv"),
  ...
  const log = `# Chart 06 Supplement Collection Log
...
`;
  ...
  await writeFile(path.join(NOTES_DIR, "chart_06_supplement_collection_log.md"), log);

  console.log(`Chart 06 supplement collection complete: ${collected.length}/${attempted} collected.`);
