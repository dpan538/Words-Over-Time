...
invariant((wheelSource.match(/<svg/g) ?? []).length === 2, "03A must use one selector SVG and one annual chart SVG");
...
invariant(cssSource.includes("clamp(278px, min(86vw, 42svh), 360px)"), "Rotary upper-field diameter contract changed");
