...
import type { ForeverClientDataset, ForeverGeneratedDataset } from "@/types/foreverRealData";
...
const referencedInspectorIds = new Set([
  ...
  ...fullDataset.categories.flatMap((category) => category.eraScores.map((score) => score.inspectorId)),
