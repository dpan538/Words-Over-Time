...
export function DesktopHome() {
  return (
    <div
      className={`${styles.root} flex min-h-screen min-w-0 flex-col bg-paper-mobile px-5 py-5 text-ink min-[960px]:bg-wheat min-[960px]:px-16 min-[960px]:py-7 xl:px-20`}
