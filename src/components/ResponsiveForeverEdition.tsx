...
const ForeverDesktopEdition = dynamic(
  () =>
    import("@/components/ForeverDesktopEdition").then(
      (module) => module.ForeverDesktopEdition,
    ),
  {
    ssr: false,
    loading: () => (
...
export function ResponsiveForeverEdition({ children }: { children: ReactNode }) {
  ...
  if (hydrated && desktop) return <ForeverDesktopEdition />;
