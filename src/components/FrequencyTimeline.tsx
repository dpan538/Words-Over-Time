...
export function FrequencyTimeline({
  ...
  return (
    <section id="spelling-frequency" className="scroll-mt-24">
      <MobileFrequencyStory
        series={visibleSeries}
        activeInspectorId={activeInspectorId}
      />

      <div className="group relative hidden overflow-hidden bg-wheat py-2 transition duration-300 hover:bg-[#f8f0da] min-[1360px]:block min-[1360px]:py-4">
