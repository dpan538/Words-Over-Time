...
export function ArtificialChart03CompoundExpansion({ activeHover, onHover }: Chart03HoverProps) {
  ...
  return (
    <div className="w-full overflow-hidden border border-ink/25">
      <div className="grid border-b border-ink/25 px-6 py-5 sm:grid-cols-[4.5rem_minmax(0,1fr)] sm:gap-6">
      ...
      <div className="relative h-[min(78vw,820px)] min-h-[660px] bg-transparent">
        ...
        <div className="absolute right-5 top-5 grid h-[22rem] w-[18rem] grid-rows-[17rem_5rem] border border-ink/20 bg-wheat/70">
          ...
          <div className="pointer-events-none relative z-10 mx-5 border-t border-ink/20 pt-3 font-mono text-[0.84rem] font-bold uppercase leading-snug tracking-[0.08em] text-fire">
            {frontLabel}
          </div>
        </div>
