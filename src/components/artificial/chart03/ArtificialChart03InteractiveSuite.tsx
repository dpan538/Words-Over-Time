...
export function ArtificialChart03InteractiveSuite() {
  ...
  return (
    <>
      ...
      <div className="mx-auto mt-12 w-full border-t border-ink/75 pt-8 sm:pt-9 lg:pt-10">
        <div className="mb-8 grid gap-3 lg:grid-cols-[15rem_minmax(0,1fr)] lg:gap-10">
          ...
          <div className="max-w-5xl">
            ...
            <p className="mt-2 max-w-[1040px] text-[1.08rem] leading-[1.55] text-ink/68">
              Part II follows artificial as a travelling prefix: it moves from sensory substitutes into matter, bodies, cognition, and social performance, turning reproduced experience into a general cultural condition.
            </p>
          </div>
        </div>
